...
SWEP.Trivia = {
    ...
    ["Muzzle Velocity"] = "2,887 ft/s",
    ["Muzzle Energy"] = "1,556 joules"
}
...
SWEP.ViewModel = "models/weapons/cs2/c_rif_m4a1.mdl"
...
SWEP.WorldModelMirror = "models/weapons/cs2/c_rif_m4a1.mdl"
...
SWEP.DropMagazineModel = "models/weapons/cs2/mags/w_rif_ak47_mag.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.ShootSound = "CS2.M4A4.Fire"
--SWEP.ShootSoundSilenced = "CS2.AK47.Fire_Silenced"
SWEP.DistantShootSound = "CS2.M4A4.Distance_Fire"
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/cs2/m4a1/m4a1_clipout.ogg", t = 11/30},
            {s = "weapons/cs2/m4a1/m4a1_clipin.ogg", t = 35/30},
            {s = "weapons/cs2/m4a1/m4a1_cliphit.ogg", t = 57/30},
        },
    },
    ["draw"] = {
        Source = "draw",
        ...
        EventTable = {
            {s = "weapons/cs2/m4a1/m4a1_draw.ogg", t = 0/30},
            {s = "weapons/cs2/m4a1/m4a1_boltback.ogg", t = 10/30},
            {s = "weapons/cs2/m4a1/m4a1_boltforward.ogg", t = 17/30},
        },
    },
    ["idle"] = {
        Source = "idle",
    ...
    ["inspect"] = {
        ...
        EventTable = {
            ...
            {s = "weapons/cs2/movement2.ogg", t = 92/30},
            {s = "weapons/cs2/movement3.ogg", t = 116/30},
        },
    },
}
